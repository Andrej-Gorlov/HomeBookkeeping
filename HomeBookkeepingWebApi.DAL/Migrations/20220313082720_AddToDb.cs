        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    L_Account = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sum = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "СreditСard",
                columns: new[] { "СreditСardId", "BankName", "L_Account", "Number", "Sum", "UserFullName", "UserId" },
                values: new object[,]
                {
                    { 1, "Сбер", "40817810100011234567", "0000 0000 0000 0000", 8000m, "Горлов Андрей", 1 },
                    { 2, "ВТБ", "40817810200021234568", "0000 0000 0000 0001", 3000m, "Горлов Андрей", 1 },
                    { 3, "Сбер", "40817810300031234569", "0000 0000 0000 0002", 5000m, "Горлова Ольга", 2 },
                    { 4, "Мир", "40817810400041234560", "0000 0000 0000 0000", 3000m, "Горлова Ольга", 2 }
                });
